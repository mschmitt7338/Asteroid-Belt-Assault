...
namespace Asteroid_Belt_Assault
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        private Texture2D spriteScreen;
        ...
        protected override void LoadContent()
        {
            ...
            spriteScreen = Content.Load<Texture2D>(@"Textures\SpriteSheet");
            starField = new StarField(this.Window.ClientBounds.Width, this.Window.ClientBounds.Height, 200, new Vector2(0, 30f), spriteScreen, new Rectangle(0, 450, 2, 2));
            asteroidManager = new AsteroidManager(10, spriteScreen, new Rectangle(0, 0, 50, 50), 20, this.Window.ClientBounds.Width, this.Window.ClientBounds.Height );
            playerManager = new PlayerManager(spriteScreen, new Rectangle(0, 150, 50, 50), 3, new Rectangle(0, 0, this.Window.ClientBounds.Width, this.Window.ClientBounds.Height));
            enemyManager = new EnemyManager(spriteScreen, new Rectangle(0, 200, 50, 50), 6, playerManager, new Rectangle(0, 0, this.Window.ClientBounds.Width, this.Window.ClientBounds.Height));
            explosionManager = new ExplosionManager(spriteScreen, new Rectangle(0, 100, 50, 50),3, new Rectangle(0, 450, 2, 2) );
